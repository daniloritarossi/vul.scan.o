    ...
    <tr><td align="center" style="padding:32px 16px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0"
        ...
        <tr><td align="center" style="padding:32px 32px 8px;">
          <img src="{logo_url}" width="72" height="72" alt="VUL.SCAN.O"
...
def send_activation(to_addr: str, username: str, token: str) -> None:
    ...
    text = (
        f"Hi {username},\n\n"
        f"An account has been created for you on VUL.SCAN.O.\n"
    ...
    html = _html_email(
        ...
        intro="An account has been created for you on VUL.SCAN.O. "
    ...
    _send(to_addr, "VUL.SCAN.O — Activate your account", text, html)
...
def send_reset(to_addr: str, username: str, token: str) -> None:
    ...
    text = (
        f"Hi {username},\n\n"
        f"A password reset was requested for your VUL.SCAN.O account.\n"
    ...
    html = _html_email(
        ...
        greeting=f"Hi <strong>{username}</strong>,",
        intro="A password reset was requested for your VUL.SCAN.O account. "
    ...
    _send(to_addr, "VUL.SCAN.O — Reset your password", text, html)
